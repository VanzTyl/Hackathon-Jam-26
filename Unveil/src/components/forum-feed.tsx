...
export function ForumFeed({ maskMode }: ForumFeedProps) {
  ...
  return (
    <div className="flex h-full flex-1 flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-border/50 bg-card/50 px-6 py-4 backdrop-blur-sm">
        ...
        <div className="relative w-64">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-background py-2 pl-10 pr-4 text-sm outline-none transition-all focus:border-accent focus:ring-2 focus:ring-accent/20"
          />
        </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <button className="relative text-sm font-medium text-primary">
            Forums
            <span className="absolute -bottom-4 left-0 right-0 h-0.5 bg-accent" />
          </button>
          <button className="text-sm text-muted-foreground transition-colors hover:text-foreground">
            Signals
          </button>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="h-9 w-9 rounded-full border-2 border-accent bg-slate-300" />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {maskMode && (
          <div className="mb-4 flex items-center gap-2 rounded-xl bg-primary/5 px-4 py-2 text-sm text-primary">
            <Ghost className="h-4 w-4" />
            <span>Mask Mode Active - Posts will be anonymous</span>
          </div>
        )}
